...
class MotionServiceA : Service(), SensorEventListener {
...
//        ContextCompat.startForegroundService(this, intent)
    ...
    private fun callAlarmManager(){
        ...
        val intent = Intent(this,RestartAlarmReceiverA::class.java)
...
class RestartAlarmReceiverA : BroadcastReceiver() {
    override fun onReceive(p0: Context?, p1: Intent?) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val intent = Intent(p0, MotionServiceA::class.java)
